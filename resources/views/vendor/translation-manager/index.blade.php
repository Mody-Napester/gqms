...
@section('title') Translations @endsection
...
@section('content')
    ...
    <script src="{{ url('assets/translation/bootstrap.min.js') }}"></script>
    <script src="{{ url('assets/translation/bootstrap-editable.min.js') }}"></script>
