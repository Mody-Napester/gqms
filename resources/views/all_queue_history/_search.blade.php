    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <select name="search_type" id="search_type" class="select2" data-placeholder="Choose ..." tabindex="-1" aria-hidden="true">
                    <option @if(request()->get('search_type') == 1) selected @endif value="1">By Desks (No reservations)</option>
                    <option @if(request()->get('search_type') == 2) selected @endif value="2">By Desks And Doctors</option>
                </select>
            </div>
        </div>
        <div class="col-md-4">
