<div class="row">
    ...
    <div class="col-md-4">
        <div class="card-box widget-box-1 bg-white">
            ...
            <p class="text-muted">Total Reservations: {{ $reservations['total'] }} <span class="pull-right"><i class="fa fa-caret-right text-primary m-r-5"></i>{{ ($reservations['done'] != 0)? round(($reservations['done']/$reservations['total']) * 100, 2) : 0 }} %</span></p>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card-box widget-box-1 bg-white">
            ...
            <p class="text-muted">Total Reservations: {{ $reservations['total'] }} <span class="pull-right"><i class="fa fa-caret-right text-primary m-r-5"></i>{{ ($reservations['waiting'] != 0)? round(($reservations['waiting']/$reservations['total']) * 100, 2) : 0 }} %</span></p>
        </div>
    </div>
