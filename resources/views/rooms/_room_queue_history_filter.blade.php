<form method="get" action="{{ route('rooms.queues.deskQueueHistory') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label>Floor</label>
                <select name="floor" id="floor" class="select2" data-placeholder="Choose ..." tabindex="-1"
                        aria-hidden="true">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label>Users</label>
                <select name="user" id="user" class="select2" data-placeholder="Choose ..." tabindex="-1"
                        aria-hidden="true">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label>Doctor</label>
                <select name="doctor" id="doctor" class="select2" data-placeholder="Choose ..." tabindex="-1"
                        aria-hidden="true">
                    <option selected disabled>Choose</option>
                    @foreach($doctors as $doctor)
                        <option value="{{ $doctor->uuid }}">{{ translate($doctor, 'name') }}</option>
                    @endforeach
                </select>
            </div>
        </div>
